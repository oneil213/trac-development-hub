...
function CreateContributor(){
  ...
  const [contributor,setContributor] = useState({username: "", password : "P@55w0rd305",  email : "" , firstname: "", lastname: "" });
  ...
  const onChange = e =>{
    ...
    const resetForm = ()=>{
      setContributor({username: "",  email : "", firstname: "", lastname: "" , password : "P@55w0rd305" });
    }
