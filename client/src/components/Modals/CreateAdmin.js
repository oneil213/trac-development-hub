...
function CreateAdmin(){
  ...
  const [admin,setAdmin] = useState({username: "", password : "P@55w0rd305",  email : "" , firstname: "", lastname: "" });
  ...
  const onChange = e =>{
    ...
    const resetForm = ()=>{
      setAdmin({username: "",  email : "", firstname: "", lastname: "" , password : "P@55w0rd305" });
    }
